...
$tituloPagina = 'Seguridad | Administrador';
...
<div class="d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-lg-center mb-4">
    ...
    <a class="btn btn-outline-dark" href="perfil.php">Perfil</a>
</div>
    ...
    <div class="col-lg-5">
        <form action="cambiar-password.php" method="post" class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo app_e(app_csrf_token('cambiar_password_admin')); ?>">
                ...
                <button class="btn btn-dark w-100" type="submit">Actualizar contrasena</button>
            </div>
        </form>
    </div>
